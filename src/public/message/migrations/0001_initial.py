    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_succeed', models.BooleanField(choices=[(0, '失败'), (1, '成功')], default=False, help_text='是否发送成功')),
                ('created', models.DateTimeField(auto_now_add=True, help_text='创建时间')),
                ('status', models.SmallIntegerField(default=1, help_text='状态: 0 trash, 1 unread, 2 read')),
            ],
            options={
                'verbose_name': '站内信息',
