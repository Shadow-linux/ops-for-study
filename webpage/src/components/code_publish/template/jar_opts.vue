  ...
  <div>
    ...
    <Modal
      ...
      <Form ref="" :model="dataForm" :label-width="100" inline>
        ...
        <FormItem label="模版:">
          <Input v-model="dataForm.jar_opts" type="textarea" :rows="10" style="width: 1050px"></Input>
        </FormItem>
      </Form>
    </Modal>
  </div>
...
<script>
// 需修改
import { getOpts, createOpts, deleteOpts, updateOpts } from '@/api/code_publish/template/jar_opts'
