  ...
  <div>
    ...
    <Modal
      ...
      <Form ref="" :model="dataForm" :label-width="100" inline>
        ...
        <FormItem label="模版:">
          <!-- 修改java_opts -->
          <Input v-model="dataForm.java_opts" type="textarea" :rows="10" style="width: 1050px"></Input>
        </FormItem>
      </Form>
    </Modal>
  </div>
...
<script>
// 需修改
import { getOpts, createOpts, deleteOpts, updateOpts } from '@/api/code_publish/template/java_opts'
              ...
              on: {
                click: () => {
                  ...
                  this.dataForm = {
                    ...
                    // 修改opts
                    'java_opts': params.row.java_opts
                  }
                }
              }
            }, '编辑')
