  ...
  <div>
    ...
    <Modal
      ...
      <Form ref="" :model="dataForm" :label-width="100" inline>
        ...
        <FormItem label="模版:">
          <Input v-model="dataForm.docker_opts" type="textarea" :rows="10" style="width: 1050px"></Input>
        </FormItem>
      </Form>
    </Modal>
  </div>
...
<script>
// 需修改
import { getOpts, createOpts, deleteOpts, updateOpts } from '@/api/code_publish/template/docker_opts'
import { sendNotice } from '@/libs/util.js'

export default {
  // 修改
  name: 'tmpl_docker_opts',
  data () {
    return {
      templateName: '',
      dataForm: {
              ...
              on: {
                click: () => {
                  ...
                  this.dataForm = {
                    ...
                    // 修改opts
                    'docker_opts': params.row.docker_opts
                  }
                }
              }
            }, '编辑')
